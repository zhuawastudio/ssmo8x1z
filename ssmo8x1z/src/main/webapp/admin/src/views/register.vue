  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">在线教学质量评价系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="督导工号" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaogonghao" autocomplete="off" placeholder="督导工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="督导姓名" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaoxingming" autocomplete="off" placeholder="督导姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">督导电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dudaodianhua" class="input" type="text" placeholder="督导电话">
			   </div>
			 </div> -->
			<el-form-item label="督导电话" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaodianhua" autocomplete="off" placeholder="督导电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">督导邮箱</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dudaoyouxiang" class="input" type="text" placeholder="督导邮箱">
			   </div>
			 </div> -->
			<el-form-item label="督导邮箱" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaoyouxiang" autocomplete="off" placeholder="督导邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`dudao` == this.tableName && this.ruleForm.dudaodianhua&&(!this.$validate.isMobile(this.ruleForm.dudaodianhua))){
        this.$message.error(`督导电话应输入手机格式`);
        return
      }
      if(`dudao` == this.tableName && this.ruleForm.dudaoyouxiang&&(!this.$validate.isEmail(this.ruleForm.dudaoyouxiang))){
        this.$message.error(`督导邮箱应输入邮件格式`);
        return
      }
      this.$http({
