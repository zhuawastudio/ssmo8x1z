  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.dudaoyouxiang!=''&&json.dudaoyouxiang){
              		this.ruleForm.dudaoyouxiang = json.dudaoyouxiang
		}
        } else {
    ...
    info(id) {
      this.$http({
        url: `tingketongzhiyoujian/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tingketongzhiyoujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tingketongzhiyoujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
